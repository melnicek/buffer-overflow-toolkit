...
# If you want to send something before or after your bad chars, set it there
pre_padding = b""
post_padding  = b""

# ./yz-patterns.py -p msf -l 4000
...
print("[+] Cyclic pattern successfully sent.")
print("[+] ./yz-patterns.py -p msf -l 4000 -f <EIP>")